...
RUN R -e "install.packages(c('shiny', 'rmarkdown', 'devtools', 'RJDBC', 'dplyr', 'plotly', 'RPostgreSQL', 'lubridate', 'DT', 'forecast', 'ggplot2', 'DBI', 'magrittr', 'stringr', 'shinyjs'), repos='http://cran.r-project.org', INSTALL_opts='--no-html')"
RUN R -e "install.packages('RPostgres', type = 'source', repos='http://cran.r-project.org', INSTALL_opts='--no-html')"
